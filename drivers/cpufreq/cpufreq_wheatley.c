...
static void wheatley_early_suspend(struct power_suspend *handler)
{
	suspended = 1;
}

static void wheatley_late_resume(struct power_suspend *handler)
{
	suspended = 0;
}

static struct power_suspend wheatley_power_suspend = {
...
static int __init cpufreq_gov_dbs_init(void)
{
	...
	register_power_suspend(&wheatley_power_suspend);
	return cpufreq_register_governor(&cpufreq_gov_wheatley);
}

static void __exit cpufreq_gov_dbs_exit(void)
{
	unregister_power_suspend(&wheatley_power_suspend);
